  ...
  return (
    ...
    <section id="mytodolist">
      <Droppable droppableId="TodoList">
        {(provider) => (
          <div className="todolist-container" ref={provider.innerRef} {...provider.droppableProps}>
          <div className={`save-undo ${JSON.stringify(myTodoList) !== JSON.stringify(loggedUser.todoList) ? "active" : ""}`}>
